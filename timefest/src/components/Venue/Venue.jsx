    ...
    <section id="venue" className="venue section" data-theme="light" aria-labelledby="venue-title">
      <div className="container">
        <div ref={headRef} className="venue__head reveal">
          <p className="chapter-mark">CHAPTER 06 — THE PLACE</p>
          <span className="micro-label">THE VENUE</span>
        ...
        <div ref={mediaRef} className="venue__media reveal">
          <figure className="venue__media-item venue__media-item--lg">
            <img src={assets.venue.portalA} alt="Expominas entrance portal at night" loading="lazy" />
          </figure>
          <figure className="venue__media-item">
            <img src={assets.venue.exteriorA} alt="Expominas exterior facade at night" loading="lazy" />
          </figure>
          <figure className="venue__media-item">
            <img src={assets.venue.interiorA} alt="Expominas interior transformed for the event" loading="lazy" />
          </figure>
        </div>
